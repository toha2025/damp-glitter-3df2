...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/damp-glitter-3df2
```

A live public deployment of this template is available at [https://damp-glitter-3df2.templates.workers.dev](https://damp-glitter-3df2.templates.workers.dev)
